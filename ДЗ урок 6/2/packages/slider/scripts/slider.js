...
let images = {
    ...
    setNextLeftImage() {
        ...
        let slideRightNow = this.slides[this.currentIdx];
        slideRightNow.classList.add('slider-animationRightToLeft');
        slideRightNow.classList.remove('hidden-slide');
        setTimeout(() => {
            slideRightNow.classList.remove('slider-animationRightToLeft');
        }, 500);
    },
    ...
    setNextRightImage() {
        ...
        let slideRightNow = this.slides[this.currentIdx];
        slideRightNow.classList.add('slider-animationLeftToRight');
        slideRightNow.classList.remove('hidden-slide');
        setTimeout(() => {
            slideRightNow.classList.remove('slider-animationLeftToRight');
        }, 500);
    },
}